export const Loader: React.FC<{ color: string, height: number }> = ({ color, height }) => {
    return (
        <svg id="spinner" width={height} height={height} viewBox="0 0 16 16" fill="none" strokeLinecap="round" stroke={color ?? "#ffffff"} strokeWidth="1px" xmlns="http://www.w3.org/2000/svg" className="shrink-0 mr-2">
